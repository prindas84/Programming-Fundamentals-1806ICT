...
typedef int *PtrList[MAX_LETTERS][MAX_LETTERS][MAX_LETTERS];
typedef int ArrList[MAX_LETTERS][MAX_LETTERS][MAX_LETTERS];
typedef bool BooLList[MAX_LETTERS][MAX_LETTERS][MAX_LETTERS];

// Prototypes for the program.
void build_search_table(PtrList table, ArrList counts);
int ctoi(char c);
void count_combinations(ArrList counts, char *word, int n);
void free_memory(PtrList table, char **word_array, int word_count);
void populate_combinations(PtrList table, ArrList counts, char *word, int n, int index);
void populate_search_table(PtrList table, ArrList counts, char **word_array, int word_count);
void search(PtrList table, ArrList counts, char **word_array, char *str);
...
int main()
{
    ...
    PtrList search_table;
    ArrList search_counts = {0};
